 ...
 * <ul>
 *   <li>{@link tdse3.tdse3.impl.CarLightImpl#getColors <em>Colors</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CarLightImpl extends MinimalEObjectImpl.Container implements CarLight {
	...
	protected EClass eStaticClass() {
		return Tdse3Package.Literals.CAR_LIGHT;
	}
	...
	public EList<colors> getColors() {
		if (colors == null) {
			colors = new EDataTypeUniqueEList<colors>(colors.class, this, Tdse3Package.CAR_LIGHT__COLORS);
		}
		return colors;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case Tdse3Package.CAR_LIGHT__COLORS:
				return getColors();
		}
